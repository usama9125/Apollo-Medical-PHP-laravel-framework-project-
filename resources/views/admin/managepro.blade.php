...
<div class="container pb-5 pt-4">
    <div class="col-sm-12 col-lg-6 m-auto border pt-2">
        <form action="{{url('/manage')}}" method="POST" enctype="multipart/form-data">
            @csrf
            <h1 class="text-center font-weight-bold pb-3"><i class="fa fa font-weight-bold">Manage Product</i></h1>
          ...
          <div class="form-group">
            ...
            <input type="text" name="Quantitiy" placeholder="Enter Product Quantitiy" class="form-control">
        </div>
        <div class="form-group ">
          <label><h6 class="fa fa font-weight-bold">image</h6></label>
          <input type="file" name="image" placeholder="Upload Product image" class="form-control">
      </div>
      <div class="form-group ">
...
<textarea name="productdescription" class="form-control" placeholder="Product Description"></textarea>    
    ...
    <div class="form-group ">
      <input type="update" name="submit" placeholder="Now update Here" class="form-control">
  </div>
  @if(session()->has('msg'))
  {{session()->get('msg')}}
  @endif
